...
public class Protocol2Server {
	...
	public void run() {
		...
		try {
			...
			if (debug) System.out.println("The nonce received is: "+serverNonceReply);
		    }
		    
		    //Protocol Step 6
		    byte[] message6pt = ("Well Done. Submit this value: "+secretValue()).getBytes();
		    byte[] message6ct = encAESsessionCipher.doFinal(message6pt);
			System.out.println("Size of message6ct: "+message6ct.length+" bytes")

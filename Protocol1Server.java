...
public class Protocol1Server {
    ...
    static String hexKey= "2B7E151628AED2A6ABF7158809CF4F3C";
	...
	public void run() {
		...
		System.out.println("Got M1: "+new String(message1));
		...
		try {
		    ...
		    System.out.println("Send M2 "+byteArrayToHexString(cipherTextM2));
		    
		    //Protocol Step 3
		    byte[] message3 = new byte[32];
		    inStream.read(message3);
		    byte[] clientNonce = decAEScipher.doFinal(message3);
		    System.out.println("Recived M3 :"+byteArrayToHexString(message3));
		    System.out.println("    Decrypts to Nc: "+byteArrayToHexString(clientNonce));
		    ...
		    System.out.println("Sending M4 pt:"+byteArrayToHexString(message4pt));
		    System.out.println("    M4 ct:"+byteArrayToHexString(cipherTextM4));
		    outStream.write(cipherTextM4); //HEREasdasd
		    
		    //Protocol Step 5 
		    byte[] cipherTextM5 =  new byte[48];
		    inStream.read(cipherTextM5);
		    System.out.println("Recived M5 ct:"+byteArrayToHexString(cipherTextM5));
		    ...
		    System.out.println("    M5 plainText:"+byteArrayToHexString(message5pt));
		    System.out.println("    M5 inNc:"+byteArrayToHexString(inNc));
		    System.out.println("    M5 inNs:"+byteArrayToHexString(inNs));
		    ...
		    System.out.println("Secret sent: "+new String(plainTextM6));
		    myConnection.close();
